...
calcium_phosphate_PO4gav <- function(t, state, parameters) {
  with(as.list(c(state, parameters)),{
    ...
    Reabs_norm <- (Reabs_PT + Reabs_TAL_basal + Reabs_TAL_CaSR_norm + Reabs_TAL_PTH_norm + 
                     Reabs_DCT_basal + Reabs_DCT_PTH_norm + 
                     Reabs_DCT_D3_norm)*GFR*(Ca_p + CaHPO4_p + CaH2PO4_p)
    ...
    Reabs_P_norm <- (Reabs_PT_basal_P + Reabs_PT_PTH_P_norm + Reabs_PT_FGF_P_norm + 
                       Reabs_PT_P_norm + Reabs_DCT_basal_P)*GFR*(PO4_p + CaHPO4_p + CaH2PO4_p + NaPO4_p)
    ...
    dCa_p <- 1/Vp*(k_inject_Ca + Abs_intest_norm  + Resorption_norm/Ca_p_norm - 
      ...
      k_diss_CaHPO4_norm*CaHPO4_norm/Ca_p_norm - k_form_CaH2PO4_norm/Ca_p_norm + 
      k_diss_CaH2PO4_norm*CaH2PO4_norm/Ca_p_norm - EGTA_form + EGTA_diss/Ca_p_norm # Plasma Ca
