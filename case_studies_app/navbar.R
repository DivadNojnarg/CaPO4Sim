...
navbar <- introBox(
  ...
  smNavBar("testMenu", "", full.width = TRUE, fixed = FALSE,
           ...
           # Basis of CaPO4 homeostasis
           smNavDropdown("Basis",
                         awesomeCheckbox("Ca_homeo", "Calcium Homeostasis", 
                                        value = FALSE,
                                        status = "success", width = NULL),
                         
                         awesomeCheckbox("PO4_homeo", "Phosphate Homeostasis", 
                                         value = FALSE,
                                         status = "success", width = NULL)
