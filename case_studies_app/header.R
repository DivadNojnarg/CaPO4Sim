...
header <- dashboardHeader(
  title="Calcium Phosphate Homeostasis: Case Study App", titleWidth = 500,
  ...
  tags$li(
    title = "",
    class = "dropdown",
    switchInput(inputId = "notif2_switch", label = "Notifications?",
                onStatus = "success", offStatus = "danger", value = TRUE, size = "mini")
  ),
