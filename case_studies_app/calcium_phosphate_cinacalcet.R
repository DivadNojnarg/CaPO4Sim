...
calcium_phosphate_core <- function (t, state, parameters){
  with(as.list(c(state, parameters)),{
    ...
    F_Ca_norm <- beta_exo_PTHg - gamma_exo_PTHg #*Ca_p^n_Ca_norm/(Ca_p^n_Ca_norm + (K_Ca/Ca_p_norm)^n_Ca_norm) # here the function is set to maximum due to cinacalcet
    ...
    D3_conv_PTH_norm <- (delta_conv_max*(D3_inact/D3_norm)*PTH_p^n_conv)/(PTH_p^n_conv + (K_conv/PTH_p_norm)^n_conv) # choose PTH_p or PTH_p_lag
    ...
    Reabs_TAL_CaSR_norm <- delta_CaSR_max # /(1+(Ca_p*Ca_p_norm/Ca_ref)^n_TAL) # again maximum effect because of cinacalcet
    ...
    Reabs_P_norm <- (Reabs_PT_basal_P + Reabs_PT_PTH_P_norm + Reabs_PT_FGF_P_norm + Reabs_PT_P_norm +
                       Reabs_DCT_basal_P)*GFR*(PO4_p+ CaHPO4_p+ CaH2PO4_p+ NaPO4_p)
    ...
    dCa_f <- Rapid_storage_Ca - Rapid_release_Ca - Accretion_norm - k_form_CaHPO4f_norm*Ca_p_norm*HPO4_norm/CaHPO4_norm + k_diss_CaHPO4f_norm - 
    ...
    dPO4_p <- 1/Vp*(k_inject_P + Abs_intest_P_norm + Resorption_P_norm/Pho_p_norm - Rapid_storage_P + Rapid_release_P - Excretion_P_norm - 
    ...
    dPO4_f <- Rapid_storage_P - Rapid_release_P - Accretion_P_norm - k_form_CaHPO4f_norm*Ca_p_norm*HPO4_norm/CaHPO4_norm + k_diss_CaHPO4f_norm - 
