...
# Commented parameters are that which are possible to change via sliderinpu buttons
...
parameters_calc <- with(list(parameters), c( r = 10^(parameters["pH"]-parameters["pKa"]),
...
parameters <- c(parameters, parameters_calc)