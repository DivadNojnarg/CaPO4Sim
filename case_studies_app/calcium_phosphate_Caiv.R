...
calcium_phosphate_Caiv <- function(t, state, parameters) {
  with(as.list(c(state, parameters)),{
    ...
    D3_synthesis_norm <- D3_basal_synthesis_norm + D3_conv_PTH_norm*
    ...
    Excretion_norm <- (1 - (Reabs_PT + Reabs_TAL_basal + Reabs_TAL_CaSR_norm + 
                              Reabs_TAL_PTH_norm + Reabs_DCT_basal + Reabs_DCT_PTH_norm + 
    ...
    list(
      c(dPTH_g, dPTH_p, dD3_p, dFGF_p, dCa_p, dCa_f, dCa_b, dPO4_p, 
        dPO4_f, dPO4_b, dPO4_c, dCaHPO4_p, dCaH2PO4_p, dCPP_p, dCaHPO4_f, dCaH2PO4_f,
