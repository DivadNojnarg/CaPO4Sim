...
#define beta_exo_PTHg parameters[1]
#define gamma_exo_PTHg parameters[2]
#define D3_inact parameters[3]
#define k_deg_D3 parameters[4]
#define k_prod_FGF parameters[5]
#define I_Ca parameters[6]
#define Lambda_ac_Ca parameters[7]
#define Lambda_ac_P parameters[8]
#define Lambda_res_min parameters[9]
#define delta_res_max parameters[10]
#define k_p_Ca parameters[11]
#define k_f_Ca parameters[12]
#define I_P parameters[13]
#define k_pc parameters[14]
#define k_cp parameters[15]
#define k_p_P parameters[16]
#define k_f_P parameters[17]
#define k_fet parameters[18]
#define k_c_CPP parameters[19]
#define Na parameters[20]
#define Prot_tot_p parameters[21]
#define Vp parameters[22]
...
#define K_Ca parameters[27]
#define gamma_prod_D3 parameters[28]
#define n1_exo parameters[29]
#define n2_exo parameters[30]
#define rho_exo parameters[31]
#define R parameters[32]
#define K_prod_PTH_P parameters[33]
#define n_prod_Pho parameters[34]
#define k_conv_min parameters[35]
#define delta_conv_max parameters[36]
#define gamma_ca_conv parameters[37]
#define gamma_D3_conv parameters[38]
#define gamma_P_conv parameters[39]
#define gamma_FGF_conv parameters[40]
#define K_conv parameters[41]
#define n_conv parameters[42]
#define gamma_deg_PTH parameters[43]
#define gamma_deg_FGF parameters[44]
#define delta_max_prod_D3 parameters[45]
#define K_prod_D3 parameters[46]
#define n_prod_FGF parameters[47]
#define K_prod_P parameters[48]
#define k_deg_FGF parameters[49]
#define K_abs_D3 parameters[50]
#define n_abs parameters[51]
#define K_res_D3 parameters[52]
#define K_res_PTH parameters[53]
#define n_res parameters[54]
#define k_f_CaHPO4 parameters[55]
#define k_d_CaHPO4 parameters[56]
#define k_f_CaH2PO4 parameters[57]
#define k_d_CaH2PO4 parameters[58]
#define f1 parameters[59]
#define f2 parameters[60]
#define f3 parameters[61]
#define k_f_CaProt parameters[62]
#define k_d_CaProt parameters[63]
#define N_Prot parameters[64]
#define k_f_NaHPO4 parameters[65]
#define k_f_NaH2PO4 parameters[66]
#define k_d_NaHPO4 parameters[67]
#define k_d_NaH2PO4 parameters[68]
#define c parameters[69]
#define d parameters[70]
...
#define k_inject_P parameters[114]
#define k_inject_Ca parameters[115]
#define k_inject_FGF parameters[116]
#define k_inject_PTH parameters[117]
#define k_inject_D3 parameters[118]
#define k_on_egta parameters[119]
...
void derivs (int *neq, double *t, double *y, double *ydot,
             double *yout, int *ip, double PTHg_basal_synthesis_norm,
             double PTHg_synthesis_D3_norm, double PTHg_synthesis_PO4_norm,
             double PTHg_synthesis_norm, double PTHg_degradation_norm,
             double n_Ca_norm, double F_Ca_norm, double PTHg_exocytosis_norm,
             double PTHp_influx_norm, double PTHp_degradation_norm,
             double D3_basal_synthesis_norm, double D3_conv_PTH_norm,
             double D3_conv_Ca_norm, double D3_conv_D3_norm,
             double D3_conv_P_norm, double D3_conv_FGF_norm, 
             double D3_synthesis_norm, double D3_degradation_norm,
             double FGF_basal_synthesis_norm, double FGF_D3_activ_norm,
             double FGF_P_activ_norm, double FGF_synthesis_norm,
             double FGF_degradation_norm, double Abs_intest_basal_norm,
             double Abs_intest_D3_norm, double Abs_intest_norm,
             double Abs_intest_basal_P_norm, double Abs_intest_D3_P_norm,
             double Abs_intest_P_norm, double Rapid_storage_Ca, 
             double Rapid_release_Ca, double Accretion_norm, 
             double Rapid_storage_P, double Rapid_release_P,
             double Accretion_P_norm, double Resorption_basal,
             double Resorption_PTH_norm, double Resorption_D3_norm,
             double Resorption_norm, double Resorption_P_norm,
             double Reabs_PT_basal, double Reabs_PT_PTH_norm, 
             double Reabs_PT, double Reabs_TAL_basal, 
             double Reabs_TAL_CaSR_norm, double Reabs_TAL_PTH_norm,
             double Reabs_DCT_basal, double Reabs_DCT_PTH_norm, 
             double Reabs_DCT_D3_norm, double Excretion_norm,
             double Reabs_norm, double Reabs_PT_basal_P, 
             double Reabs_PT_PTH_P_norm, double Reabs_PT_FGF_P_norm,
             double Reabs_PT_P_norm, double Reabs_DCT_basal_P,
             double Excretion_P_norm, double Reabs_P_norm,
             double Plasma_intra_Flux_norm, double Intra_plasma_Flux_norm,
             double k_form_CaHPO4_norm, double k_diss_CaHPO4_norm,
             double k_form_CaH2PO4_norm, double k_diss_CaH2PO4_norm,
             double k_form_CaHPO4f_norm, double k_diss_CaHPO4f_norm,
             double k_form_CaH2PO4f_norm, double k_diss_CaH2PO4f_norm,
             double k_fet_CaHPO4_norm, double k_fet_CaH2PO4_norm,
             double CPP_degradation, double k_form_CaProt, 
             double k_diss_CaProt, double k_form_NaPO4, double k_diss_NaPO4,
             double EGTA_form, double EGTA_diss)
{
