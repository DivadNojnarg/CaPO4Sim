...
generate_nodes_intestine <- function() {
  ...
  data.frame(
    ...
    shape = c(rep("text",9)), 
    label = c(rep("",9)),
    x = c(263,155,159,207,209,83,81,32,83), 
    y = c(358,359,260,244,280,263,199,263,337), 
    color = list(background = "#97C2FC", border = "#97C2FC", 
                 highlight = list(background = "orange", border = "orange")),
    size = c(rep(10,9)), 
    #fixed = list("x" = TRUE, "y" = TRUE),
...
generate_nodes_bone <- function() {
  ...
  data.frame(
    ...
    shape = c(rep("text",11)), 
    label = c(rep("",11)),
    x = c(-188,-186,-148,-158,-134,-112,-47,-38,15,-3,-34), 
    y = c(49,108,111,-2,0,-3,38,101,196,-10,92), 
    color = list(background = "#97C2FC", border = "#97C2FC", 
                 highlight = list(background = "orange", border = "orange")),
    size = c(rep(10,11)), 
    #fixed = list("x" = TRUE, "y" = TRUE),
