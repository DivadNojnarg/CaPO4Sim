graph_notification_list <- list(
  php1 = c("The coefficient of PTH production may be 
           increased by several times its base case value (until 300 times).
           This can be achieved using the orange slider below the graph window.
           ...
           PTH production is normal). The case study starts with the slider set
           to 0. Therefore, all normalized concentrations and fluxes are equal
           to 1."),
  
  hypopara = c("This is a simulation of hypoparathyroidism in the rat. 
               The coefficient of PTH production is decreased several 
               times its base case value (until 0). \\([Ca^{2+}]_p\\),
